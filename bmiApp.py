...
height_cm = st.number_input("กรอกส่วนสูงของคุุณ (เซนติเมตร):", min_value=1.0, value=1.0)
...
if bmi < 18.5:
      st.warning("📢 คุณมีน้ำหนักน้อยกวาสเกณฑ์ (ผอม)")
elif 18.5 <= bmi 23.0:
...
st.divider()
st.write("นาย ชนาธิป ทาเกิด เลขที่ 34 ม.4/12")
